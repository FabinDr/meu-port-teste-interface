  ...
  const projects = [
    {
      ...
      shortDescription: t('project1Short'),
      fullDescription: t('project1Full'),
      ...
      features: t('project1Features') || []
    },
    {
      id: 2,
      title: t('project2Title'),
      shortDescription: t('project2Short'),
      fullDescription: t('project2Full'),
      ...
      features: t('project2Features') || []
    },
    {
      id: 3,
      title: t('project3Title'),
      shortDescription: t('project3Short'),
      fullDescription: t('project3Full'),
