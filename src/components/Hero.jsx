          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute top-1/2 -right-20 md:-right-24 lg:-right-28 w-14 h-14 bg-transparent ring-2 ring-primary rounded-full flex items-center justify-center text-primary shadow-[0_0_25px_rgba(0,212,255,0.35)]"
              >
